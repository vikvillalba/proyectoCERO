...
public class InscripcionesBO implements IInscripcionesBO{
    ...
    public List<InscripcionDTO> obtenerInscripcionesAlumno(AlumnoDTO alumnoDTO) throws NegocioException{
        Alumno alumno = new Alumno(alumnoDTO.getCodigo(), alumnoDTO.getApellidoPaterno(), alumnoDTO.getApellidoMaterno(), alumnoDTO.getNombre(), alumnoDTO.getTelefono(), alumnoDTO.getFechaNacimiento(), alumnoDTO.getCorreoElectronico());
        List<Inscripcion> inscripciones = this.inscripcionesDAO.obtenerInscripcionesAlumno(alumno);
        if(inscripciones.isEmpty()){
            String nombreAlumno = alumno.getApellidoPaterno() + " " + alumno.getNombre();
            throw new NegocioException("No se encontraron inscripciones en clases activas para el alumno: " + nombreAlumno);
        }
