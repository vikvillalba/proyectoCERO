...
public class PanelGuardarClase extends javax.swing.JPanel {
    ...
    private void configurarComboxModalidades() {
        ...
        // Agregar listener para habilitar/deshabilitar comboxAulas
        comboxModalidad.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    String modalidadSeleccionada = (String) comboxModalidad.getSelectedItem();
                    boolean esVirtual = "Virtual".equalsIgnoreCase(modalidadSeleccionada);
                    comboxAulas.setEnabled(!esVirtual); // Desactivar si es Virtual
                }
            }
        });
    }
...
// Aula (solo si la modalidad es Presencial)
        AulaClaseDTO aulaSeleccionada = null;
        if ("Presencial".equalsIgnoreCase(modalidadSeleccionada)) {
            aulaSeleccionada = (AulaClaseDTO) comboxAulas.getSelectedItem();
        }

// Horas - Obtener hora y minuto desde los spinners personalizados
...
// Crear objeto DTO
        NuevaClaseDTO nuevaClase = new NuevaClaseDTO(
                ...
                aulaSeleccionada, // será null si modalidad es virtual
                diasSeleccionados,
                horaInicioCompleta,
                horaFinCompleta,
                fechaInicio,
