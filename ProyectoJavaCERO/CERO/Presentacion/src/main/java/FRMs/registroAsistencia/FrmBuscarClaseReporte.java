...
public class FrmBuscarClaseReporte extends javax.swing.JFrame {
    ...
    public FrmBuscarClaseReporte(List<ClaseListaDTO> clases) {
        initComponents();
        this.clases = clases;
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        ClaseListaDTO claseSeleccionada = (ClaseListaDTO) cbClases.getSelectedItem();
        ControlNavegacion.mostrarReportesAsistencias(claseSeleccionada);
        this.dispose();
    ...
    private javax.swing.JComboBox<ClaseListaDTO> cbClases;
