...
import com.mycompany.dtos.JustificanteDTO;
...
public class FrmJustificarFalta extends javax.swing.JFrame {
    ...
    public FrmJustificarFalta(AsistenciaDTO asistencia) {
        initComponents();
    ...
    private void cargarDatos(){
        String nombreAlumno = asistencia.getAlumno().getNombre() + " " + asistencia.getAlumno().getApellidoPaterno();
        this.lblCodigo.setText(String.valueOf(asistencia.getAlumno().getCodigo()));
        this.lblNombre.setText(nombreAlumno);
        this.lblFecha.setText(asistencia.getFechaHora().toLocalDate().toString());
    }
