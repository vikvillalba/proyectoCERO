 ...
 */
public class PnlClaseInscrita extends javax.swing.JPanel {
    private AlumnoDTO alumno;
    private ClaseDTO clase;
    private JFrame frame;

    public PnlClaseInscrita(ClaseDTO clase,  AlumnoDTO alumno, JFrame frame) {
        initComponents();
        this.clase = clase;
        this.alumno = alumno;
        this.frame = frame;
   ...
   private void configurarDatos() {
    ...
    private void initComponents() {
        ...
        setBackground(null);
        setPreferredSize(new java.awt.Dimension(1225, 140));
        ...
        btnRegistrarAsistencia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Utilerias/botones/btnRegistro.png"))); // NOI18N
        ...
        add(btnRegistrarAsistencia, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 30, 310, 70));
